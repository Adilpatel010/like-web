...
const Contact = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-12 font-poppins">
            <h2 className="text-xl md:w-130 flex justify-center items-center md:text-3xl font-semibold text-white p-3 rounded-2xl bg-[#AB2E26] mb-17">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="rounded-xl overflow-hidden border-1 hover:border-[#AB2E26]">
                    <iframe
                        title="Google Map"
